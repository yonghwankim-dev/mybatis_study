...
public class Member3 {
	...
	private LibRegiNumType2 lib_regi_num;
	...
	public static class Builder {
		...
		public Builder lib_regi_num(LibRegiNumType2 lib_regi_num) {
	...
	public LibRegiNumType2 getLib_regi_num() {
		return lib_regi_num;
	}
	...
	public String toString() {
		return "Member [mem_num=" + mem_num + ", pwd=" + pwd + ", mem_email=" + mem_email + ", mem_name=" + mem_name
